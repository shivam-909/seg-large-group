    ...
    return (
        <div className='border-2 border-darker-grey rounded-xl w-full p-4 m-2'>
            <div className={"float-right grid grid-cols-1"}>
                ...
                <button onClick={async () => {await axios.delete("http://localhost:8080/api/jobs" + props.id)}} className={"bottom-0"}><i className="fa-solid fa-trash text-red text-xl"></i></button>
            </div>
