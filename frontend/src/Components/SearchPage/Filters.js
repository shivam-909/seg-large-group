...
function Filters() {
    return (
        <div className='flex items-center justify-center'>
            ...
            <Filter html={[<option value="None">Distance</option>, <option value="5">5 miles</option>, <option value="10">10 miles</option>, <option value="15">15 miles</option>, <option value="20">20 miles</option>, <option value="25">25 miles</option>]}/>
